...
**SketchyOrNot does _not_ say something is safe.**  

Instead, it shows you what might look suspicious, based on patterns and red flags.  

You read the results, learn what to look for, and decide what to do next.
...
If you want to support the project and help more people stay scam-aware, you can **leave a tip**. That’s it. No upsells, no memberships, no guilt.
