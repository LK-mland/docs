...
<CardGroup cols={2}>
  ...
  <Card title="FAQ" icon="screwdriver-wrench" href="https://mintlify.com/docs/content/components/accordions">
...
[SketchyOrNot.com](http://SketchyOrNot.com) helps you quickly check if a screenshot of a message, email, or DM might have sketchy signs — before you click, reply, or make any kind of financial commitment. You just upload or drag in a screenshot, and the AI returns useful insights whether it's Sketchy or Not, so **you can make a more informed decision**.
...
2. The AI looks for **signs that something might be sketchy**, like:
   - Urgent, pushy or threatening wording
...
### 🛑 Will this tell me if something is “safe” or “dangerous”?

No.

**_SketchyOrNot does not say something is safe._**

Instead, it shows you what might look suspicious, based on patterns and red flags. It will tell you if it's Sketchy or Not\! 

You read the results, learn what to look for, and then make a safer more informed decision. 
...
Yes — that’s part of the mission.
...
If you want to support the project and help more people stay scam-aware, you can **leave a tip**. (See the bottom of the main website page if you would like to support)  That’s it. No upsells, no memberships, no sign in, no hassle\! 

---

### 🤖 What tech is behind this?

We use AI to analyze screenshots for sketchy language, patterns, and behavior — including **XYZ AI (name of what will be used) ** The smart part runs in the background, but the experience stays simple, fast, and human-friendly for you.
